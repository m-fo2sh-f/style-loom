                ...
                <Box sx={{ width: '90%', mx: 'auto', mt: 5, borderRadius: '10px', border: '2px dashed', borderColor: theme.palette.primary.main }}>
                    ...
                    <Stack flexDirection={'row'} flexWrap={'wrap'} >
                        <Box
                            ...
                            <Typography variant="h6" sx={{ color: theme.palette.primary.contrastText }}>{data?.material}</Typography>
                        </Box>
                        <Box
                            sx={{
                            ...
                            <Typography variant="h6" sx={{ color: theme.palette.primary.contrastText }}> {data?.description}</Typography>
                        </Box>
                        <Box
                            sx={{
