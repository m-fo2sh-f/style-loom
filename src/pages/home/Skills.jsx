...
export const Skills = () => {
    ...
    useGSAP(() => {
        const proTL = gsap.timeline({ scrollTrigger: { trigger: '.skills-section', start: 'top +500' } })
        proTL.from('.skills-section ', {
            opacity: 0,
            y: 50,
            duration: 1,
        })
    ...
    return (
        <Box ref={skillsSection}>
            <Box className='skills-section' sx={{ mt: 5, width: '90%', mx: 'auto', border: '2px dashed', borderRadius: '15px', borderColor: theme.palette.primary.main, }}>
                <Stack sx={{ width: '100%', }} >
                    <Box sx={{
                        width: '100%',
                        p: 5,
