...
const Process = () => {
    ...
    const processSection = React.useRef()
    useGSAP(() => {
        const proTL = gsap.timeline({ scrollTrigger: { trigger: '.process-section', start: 'top +500' } })
        proTL.from('.process-section ', {
            opacity: 0,
            y: 50,
            duration: 1,
        })
